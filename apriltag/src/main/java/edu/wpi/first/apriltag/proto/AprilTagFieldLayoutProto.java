...
public class AprilTagFieldLayoutProto implements Protobuf<AprilTagFieldLayout, ProtobufAprilTagFieldLayout> {
    @Override
  ...
  public AprilTagFieldLayout unpack(ProtobufAprilTagFieldLayout msg) {
      ...
      return new AprilTagFieldLayout(, msg.getFieldDimensions().getLength(), msg.getFieldDimensions().getWidth());
  }
}
